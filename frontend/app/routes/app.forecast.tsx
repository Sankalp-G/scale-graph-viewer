...
import type { Route } from "./+types/app.forecast";

export function meta({}: Route.MetaArgs) {
  return [
    { title: "Graph Forecast viewer" },
    { name: "description", content: "Graph Forecast viewer" },
  ];
}
...
export default function App() {
  ...
  const handleStart = async () => {
    ...
    try {
      const res = await fetch(joinUrl(apiBase, "/forecast/start"), {
        method: "POST",
